...
## Final Thoughts
After having used both softwares, I feel R is much more useful in regards to statiscal analysis. This maybe due to the fact that I have used R more in general in my research and some of my other classes, giving me much more experience with R. It is worth noting that much of what can be done on Python can also be done on R. Seeing that R can do a lot of what Python does, along with being able to perform statistical analysis in an easier manner, I can truly say R is much more useful than Python. 